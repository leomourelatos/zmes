...
* Determine which operating slash and download directory to use
  CASE 'X'.
    WHEN ppc.
      ...
      IF sopack-low <> ' '.
        CONCATENATE pfolder '\' sopack-low '\' pmlang '\' INTO pfolder.
      ENDIF.
...
*   Select tables
    WHEN rtable.
      ...
      CONCATENATE downloadfolder '\' trtable '\' INTO downloadfolder.
    ...
    WHEN rtabtype.
      ...
      CONCATENATE downloadfolder '\' trtabtyp '\' INTO downloadfolder.
...
*   Select message classes tables
    WHEN rmess.
      ...
      CONCATENATE downloadfolder '\' tpmes '\' INTO downloadfolder.
...
*   Select function modules
    WHEN rfunc.
      ...
      CONCATENATE downloadfolder '\' trfunc '\' INTO downloadfolder.
...
*   Select Classes
    WHEN rclass.
      ...
      CONCATENATE downloadfolder '\' trclass '\' INTO downloadfolder.
...
*   Select programs
    WHEN rprog.
      ...
      CONCATENATE downloadfolder '\' tprog '\' INTO downloadfolder.
    ...
    WHEN rxslt.
      ...
      CONCATENATE downloadfolder '\' trxslt '\' INTO downloadfolder.
